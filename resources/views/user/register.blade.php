...
<html lang="en">
    ...
    <head>
        ...
        <title>Báo lỗi/sự cố HUPH - Đăng ký</title>
        ...
        <div class="wrapper-page">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="p-3">
                        <h4 class="text-muted font-18 m-b-5 text-center">TRANG ĐĂNG KÝ TÀI KHOẢN</h4>
                        <p class="text-muted text-center">Sử dụng email thuộc hệ thống mail của nhà trường (...@huph.edu.vn)</p>
